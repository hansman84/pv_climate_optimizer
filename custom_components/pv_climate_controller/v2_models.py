...
class V2RoomInput:
    ...
    # PV hold mode (0 = off): the room is kept at comfort minus this many K
    # while real PV surplus lasts instead of being switched off at comfort.
    ...
    occupied_window_active: bool = False
