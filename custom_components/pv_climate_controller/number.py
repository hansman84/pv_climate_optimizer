...
class _HouseCoolingNumber(ControllerEntity, NumberEntity):
    """Visible, persisted whole-house comfort controls."""

    _attr_entity_category = EntityCategory.CONFIG
    _attr_native_step = 0.1


class CoolingStartOffsetNumber(_HouseCoolingNumber):
    _attr_name = "Kühlstart über Komforttemperatur"
    _attr_native_min_value = 0.0
    ...
    @property
    def native_value(self) -> float:
        return self.controller.config.cooling_start_offset_c
